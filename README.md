...
Note: Be careful to never enter your own username when prompted for a username to chat with. Also, chat messages cannot contain apostrophes, an unfortunate side effect of the SQLite database queries.